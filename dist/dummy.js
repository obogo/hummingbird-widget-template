 ...
 */
    ...
    internal("templates_0", [ "app" ], function(app) {
        app.template("8b8c67d7_tpl0", "<div>{{model}}</div><div dummy-label=model.text hb-click=update()></div>");
        app.template("8b8c67d7_tpl1", "<div>You said: {{title}} {{text}}</div>");
    });
    for (var name in cache) {
